...
if( !class_exists('Briddge_Google_Fonts_Function') ) {
...
$briddge_styles->briddge_typo_settings( 'content-typography', '.editor-block-list__layout .editor-block-list__block,
...
//lead typo styles
$briddge_styles->briddge_typo_settings( 'lead-typography', '.editor-block-list__layout .editor-block-list__block .lead' );

//h1 typo styles
$briddge_styles->briddge_typo_settings( 'h1-typography', '.editor-block-list__layout .editor-block-list__block h1,
...
//h2 typo styles
$briddge_styles->briddge_typo_settings( 'h2-typography', '.editor-block-list__layout .editor-block-list__block h2, h2, .block-editor-block-list__layout h2.block-editor-block-list__block' );

//h3 typo styles
$briddge_styles->briddge_typo_settings( 'h3-typography', '.editor-block-list__layout .editor-block-list__block h3, h3, .block-editor-block-list__layout h3.block-editor-block-list__block' );

//h4 typo styles
$briddge_styles->briddge_typo_settings( 'h4-typography', '.editor-block-list__layout .editor-block-list__block h4, h4, .block-editor-block-list__layout h4.block-editor-block-list__block' );

//h5 typo styles
$briddge_styles->briddge_typo_settings( 'h5-typography', '.editor-block-list__layout .editor-block-list__block h5, h5, .block-editor-block-list__layout h5.block-editor-block-list__block' );

//h6 typo styles
$briddge_styles->briddge_typo_settings( 'h6-typography', '.editor-block-list__layout .editor-block-list__block h6, h6, .block-editor-block-list__layout h6.block-editor-block-list__block' );

//site link color
$briddge_styles->briddge_link_color( 'link-color', 'regular', '.post-type-post .editor-block-list__layout .editor-block-list__block a' );
$briddge_styles->briddge_link_color( 'link-color', 'hover', '.post-type-post .editor-block-list__layout .editor-block-list__block a:hover' );
$briddge_styles->briddge_link_color( 'link-color', 'active', '.post-type-post .editor-block-list__layout .editor-block-list__block a:active, .post-type-post .editor-block-list__layout .editor-block-list__block a:focus' );
...
//button color
$briddge_styles->briddge_link_color( 'button-color', 'regular', '.wp-block-button__link' );
$briddge_styles->briddge_link_color( 'button-color', 'hover', '.wp-block-button__link:hover' );
$briddge_styles->briddge_link_color( 'button-color', 'active', '.wp-block-button__link:active, .wp-block-button__link:focus' );