 ...
 * @see Walker_Nav_Menu
 */
class Briddge_Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
	/**
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<?php 
				/* Custom code */ 
				$briddge_advance_menu = true;
				if( $briddge_advance_menu ):
				?>
				<p class="field-briddge-custom-settings description-wide">
					<label for="edit-menu-item-custom-settings-<?php echo $item_id; ?>">
						<span><?php esc_html_e( 'Briddge Custom', 'briddge-addon' ); ?></span>
						<?php
						printf(
							'<a href="#briddge-general-settings-form" class="item-general-settings briddge-general-settings-form" data-menu="%1$s" data-depth="%2$s">%3$s</a>',
							esc_attr( $item_id ),
							esc_attr( $depth ),
							esc_html__( 'Settings', 'briddge-addon' )
						);
						$briddge_menu = $item->briddgemenu ? $item->briddgemenu : json_encode( array( "icon" => "", "megamenu" => "", "megamenucol" => "", "megamenuwidget" => '' ));
						?>
						<textarea id="edit-menu-item-briddge-<?php echo $item_id; ?>" class="widefat edit-menu-item-briddge screen-reader-text" rows="3" cols="20" name="menu-item-briddgemenu[<?php echo $item_id; ?>]"><?php echo esc_html( $briddge_menu ); // $item->briddgemenu textarea_escaped ?></textarea>
					</label>
				</p>
				<?php endif; 
				/* Custom code end */ 
