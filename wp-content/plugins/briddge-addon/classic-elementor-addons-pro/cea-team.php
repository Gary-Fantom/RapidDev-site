					...
					<div class="row">
						...
						<div class="col-md-6 team-email-wrap">
							<div class="team-media media">
								...
								<div class="media-body">
									<span class="team-email-label"><?php esc_html_e( 'Email', 'briddge-addon' ) ?></span>
						...
						<div class="col-md-6 team-phone-wrap">
							<div class="team-media media">
								...
								<div class="media-body">
									<span class="team-phone-label"><?php esc_html_e( 'Phone', 'briddge-addon' ) ?></span>
						...
						<div class="col-md-6 team-website-wrap">
							<div class="team-media media">
								...
								<div class="media-body">
									<span class="team-website-label"><?php esc_html_e( 'Website', 'briddge-addon' ) ?></span>
						...
						<div class="col-md-6 team-experience-wrap">
							<div class="team-media media">
								...
								<div class="media-body">
									<span class="team-details-label"><?php esc_html_e( 'Experience', 'briddge-addon' ) ?></span>
