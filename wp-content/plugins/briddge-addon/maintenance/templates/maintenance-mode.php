...
<div class="container text-center maintenance-wrap">
	<div class="row">
		<div class="col-md-12">
			<h1 class="maintenance-title"><?php esc_html_e( 'Under Maintenance', 'briddge-addon' ); ?></h1>
		</div>
	</div>
	<div class="row">
		<div class="col-md-4">
	...
	<div class="row">
		<div class="col-md-12 maintenance-footer">
			<p><?php esc_html_e( 'We are currently in maintenance mode. We will be back soon.', 'briddge-addon' ); ?></p>
		</div>
	</div>
