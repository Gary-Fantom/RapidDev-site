<?php
class briddge_about_widget extends WP_Widget {
	/**
	 * Widget setup.
	 */
	public function __construct() {
		$widget_ops = array( 'classname' => 'zozo_about_widget', 'description' => esc_html__('A widget that displays an About widget', 'briddge-addon') );
		$control_ops = array('id_base' => 'zozo_about_widget' );
		parent::__construct( 'zozo_about_widget', esc_html__('Briddge About Me', 'briddge-addon'), $widget_ops, $control_ops );
	}
	/**
	...
	public function form( $instance ) {
		...
		<!-- image url -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php esc_html_e('Image URL:', 'briddge-addon'); ?></label>
		...
		<!-- round image -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'round' ) ); ?>"><?php esc_html_e('Make image a circle:', 'briddge-addon'); ?></label>
			...
			<br><small><?php esc_html_e('For a perfect circle your image need to have the same height and width. For example: 260x260', 'briddge-addon'); ?></small>
		</p>
		
		<!-- description -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>"><?php esc_html_e('About me text:', 'briddge-addon'); ?></label>
		...
		<!-- Signature Image-->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'sign_image' ) ); ?>"><?php esc_html_e('Signature Image URL:', 'briddge-addon'); ?></label>
		...
		<!-- Authorurl -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'author_url' ) ); ?>"><?php esc_html_e('Author Url:', 'briddge-addon'); ?></label>
		...
		<!-- link Text -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'readmore_text' ) ); ?>"><?php esc_html_e('Read More Text:', 'briddge-addon'); ?></label>
