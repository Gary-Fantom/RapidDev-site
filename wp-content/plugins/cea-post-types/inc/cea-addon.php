	...
	public function init_widgets() {
		...
		foreach( $shortcode_stat as $key => $value ){
			...
			if( $saved_val ){
				...
				switch( $key ){
					case 'portfolio': Plugin::instance()->widgets_manager->register_widget_type( new CEA_Elementor_Portfolio_Widget() );  break;
					case 'service': Plugin::instance()->widgets_manager->register_widget_type( new CEA_Elementor_Service_Widget() );  break;
					case 'event': Plugin::instance()->widgets_manager->register_widget_type( new CEA_Elementor_Event_Widget() );  break;
					case 'team': Plugin::instance()->widgets_manager->register_widget_type( new CEA_Elementor_Team_Widget() );  break;
					case 'testimonial': Plugin::instance()->widgets_manager->register_widget_type( new CEA_Elementor_Testimonial_Widget() );  break;					
				}
