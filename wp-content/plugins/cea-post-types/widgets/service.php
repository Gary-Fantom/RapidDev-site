...
class CEA_Elementor_Service_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		//get post titles
		$post_titles = Cea_Post_Helper::cea_get_post_titles( 'cea-service' );
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for service masonry or normal.", "cea-post-types" ),
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Here you can mention service masonry gutter size. Example 30", "cea-post-types" ),
				"default" 		=> "10",
				"condition" 	=> [
					"service_masonry" 		=> "yes",
					"service_layout!" 		=> "list"
	...
	public function render_content() {
		...
		<div class="elementor-widget-container service-wrapper<?php echo esc_attr( $class_names ); ?>">
	...
	protected function render() {
		...
		if ( $query->have_posts() ) {
			...
			while ( $query->have_posts() ) : $query->the_post();
				...
				}elseif( $service_masonry && $isotope_filter && $filter_catoutput != '' ){
				...
				echo '<div class="'. esc_attr( $col_class . $cat_class ) .'" '. $this->get_render_attribute_string( 'cea-service-tilt' ) .'>';
