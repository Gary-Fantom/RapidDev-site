...
/**
 * Classic Elementor Addon Portfolio Widget
 *
 * @since 1.0.0
 */
 
class CEA_Elementor_Portfolio_Widget extends Widget_Base {	
	...
	public function get_title() {
		return __( "Portfolio", "cea-post-types" );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'magnific-popup', 'owl-carousel', 'infinite-scroll', 'isotope', 'cea-custom-front'  ];
	}
	...
	protected function register_controls() {
		...
		//get categories
		$categories = Cea_Post_Helper::cea_post_type_taxonomies( 'term_id', 'portfolio-categories' );
		
		//get post titles
		$post_titles = Cea_Post_Helper::cea_get_post_titles( 'cea-portfolio' );
		...
		$this->start_controls_section(
			...
			[
				...
				"description"	=> esc_html__( "Default portfolio options.", "cea-post-types" ),
			]
		);
		$this->add_control(
			"extra_class",
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"	=> Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Portfolio query options.", "cea-post-types" ),
			]
		);
		$this->add_control(
			"post_per_page",
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .portfolio-wrapper .portfolio-inner' => 'text-align: {{VALUE}};',
				],
			]
		);		
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio columns.", "cea-post-types" ),
				"default"		=> "6",
				"options"		=> [
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio masonry or normal.", "cea-post-types" ),
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Here you can mention portfolio masonry gutter size. Example 30", "cea-post-types" ),
				"default" 		=> "10",
				"condition" 	=> [
					"portfolio_masonry" 		=> "yes",
					"portfolio_layout!" 		=> "list"
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Enabel to show portfolio filter by category.", "cea-post-types" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no",
				"condition" 	=> [
					"portfolio_masonry" => "yes",
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Here you can mention portfolio's first filter text.", "cea-post-types" ),
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio masonry infinite scroll.", "cea-post-types" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no",
				"condition" 	=> [
					"portfolio_masonry" => "yes",
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio variatoin either dark or light.", "cea-post-types" ),
				"default"		=> "light",
				"options"		=> [
		...
		$this->add_control(
			...
			[
				"label"				=> "Post Items",
				"description"		=> esc_html__( "This is settings for portfolio custom layout. here you can set your own layout. Drag and drop needed portfolio items to Enabled part.", "cea-post-types" ),
				"type"				=> "dragdrop",
				"ddvalues" 			=> [ 
					"Enabled" 		=> [ 
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is settings for portfolio shortcode post overlay items.", "cea-post-types" ),
				"type"			=> "dragdrop",
				"ddvalues"		=> [
					...
					esc_html__( "disabled", "cea-post-types" ) => [
						...
						'icons'	=> esc_html__( 'Zoom/Link Icon', 'cea-post-types' ),
						'date'	=> esc_html__( 'Date', 'cea-post-types' ),
						'comment'	=> esc_html__( 'Comment', 'cea-post-types' ),
						'title'	=> esc_html__( 'Title', 'cea-post-types' ),
						"top-meta"		=> esc_html__( "Top Meta", "cea-post-types" ),
						"bottom-meta"	=> esc_html__( "Bottom Meta", "cea-post-types" )
					]
		...
		$this->add_control(
			...
			[
				"label"			=> "Post Top Meta",
				"description"	=> esc_html__( "This is settings for portfolio shortcode post top meta.", "cea-post-types" ),
				"type"			=> "dragdrop",
				"ddvalues"		=> [ 
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is settings for portfolio shortcode post bottom meta.", "cea-post-types" ),
				"type"			=> "dragdrop",
				"ddvalues"		=> [ 
					esc_html__( "Left", "cea-post-types" ) => [],
					esc_html__( "Right", "cea-post-types" ) => [],
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Portfolio slide options here available.", "cea-post-types" ),
			]
		);
		$this->add_control(
			"slide_opt",
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider option.", "cea-post-types" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slide items shown on large devices.", "cea-post-types" ),
				"default" 		=> "2",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slide items shown on tab.", "cea-post-types" ),
				"default" 		=> "2",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slide items shown on mobile.", "cea-post-types" ),
				"default" 		=> "1",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider auto play.", "cea-post-types" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider loop.", "cea-post-types" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider center, for this option must active loop and minimum items 2.", "cea-post-types" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider navigation.", "cea-post-types" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider pagination.", "cea-post-types" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider margin space.", "cea-post-types" ),
				"default" 		=> "",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider duration.", "cea-post-types" ),
				"default" 		=> "5000",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider smart speed.", "cea-post-types" ),
				"default" 		=> "250",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider scroll by.", "cea-post-types" ),
				"default" 		=> "1",
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				'name' => 'post_shadow',
				'selector' => '{{WRAPPER}} .portfolio-inner',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner:hover' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				'name' => 'post_hshadow',
				'selector' => '{{WRAPPER}} .portfolio-inner:hover',
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner:hover .post-title-head .post-title' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner:hover .post-title-head' => 'transform: scale({{SIZE}});'
				],
			]
		);	
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner .post-excerpt' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner:hover .post-excerpt' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner .post-overlay-items' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .portfolio-inner:hover .post-overlay-items' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
	...
	public function render_content() {
		...
		$portfolio_layout = isset( $portfolio_layout ) && $portfolio_layout != '' ? $portfolio_layout : 'default';
		$slide_opt = isset( $slide_opt ) && $slide_opt == 'yes' ? true : false;
		$portfolio_masonry = isset( $portfolio_masonry ) && $portfolio_masonry == 'yes' ? true : false;
		...
		<div class="elementor-widget-container portfolio-wrapper<?php echo esc_attr( $class_names ); ?>">
	...
	protected function render() {
		...
		$portfolio_pagination = isset( $portfolio_pagination ) && $portfolio_pagination == 'yes' ? true : false;
		$portfolio_masonry = isset( $portfolio_masonry ) && $portfolio_masonry == 'yes' ? true : false;
		$masonry_layout = isset( $masonry_layout ) && $masonry_layout != '' ? $masonry_layout : 'masonry';
		$portfolio_infinite = isset( $portfolio_infinite ) && $portfolio_infinite == 'yes' ? true : false;
		...
		if( $tilt_opt ){
			$this->add_render_attribute( 'cea-portfolio-tilt', 'data-tilt_trans', $tilt_transition );
			$this->add_render_attribute( 'cea-portfolio-tilt', 'data-max_tilt', $max_tilt );
			$this->add_render_attribute( 'cea-portfolio-tilt', 'data-tilt_perspective', $perspective );
			$this->add_render_attribute( 'cea-portfolio-tilt', 'data-tilt_scale', $tilt_scale );
			$this->add_render_attribute( 'cea-portfolio-tilt', 'data-tilt_speed', $tilt_speed );
		}
		...
		if( $isotope_filter && !empty( $include_cats ) ){
			foreach( $include_cats as $index => $cat ){
				if( term_exists( absint( $cat ), 'portfolio-categories' ) ){
					$cat_term = get_term_by( 'id', absint( $cat ), 'portfolio-categories' );	
					if( isset( $cat_term->term_id ) ){
						$filter_catoutput .=  '<li><a href="#" class="isotope-filter-item" data-filter=".portfolio-filter-'. esc_attr( $cat ) .'">'. esc_html( $cat_term->name ) .'</a></li>';	
					}
				}
			}
		}
		...
		if ( $query->have_posts() ) {
			...
			if( $slide_opt ) {
				...
				echo '<div class="isotope'. esc_attr( $isotope_class ) .'" data-cols="'. esc_attr( 12 / absint( $cols ) ) .'" data-gutter="'. esc_attr( $portfolio_gutter ) .'" data-layout="'. esc_attr( $masonry_layout ) .'" data-infinite="'. esc_attr( $portfolio_infinite ) .'" data-lazyload="'. esc_attr( $lazy_load ) .'" >';
			...
			if( $list_layout || $portfolio_layout == 'classic-pro' ){
			...
			while ( $query->have_posts() ) : $query->the_post();
				...
				echo '<div class="'. esc_attr( $col_class . $cat_class ) .'" '. $this->get_render_attribute_string( 'cea-portfolio-tilt' ) .'>';
					echo '<div class="portfolio-inner">';
						
						if( $list_layout ){
							echo '<div class="media">';
								echo $this->cea_portfolio_shortcode_elements('thumb', $portfolio_array, $settings);
								echo '<div class="media-body">';
						}elseif( $portfolio_layout == 'classic-pro' ){
							echo $this->cea_portfolio_shortcode_elements('thumb', $portfolio_array, $settings);
						...
						if( isset( $elemetns['Enabled'] ) ) :
							foreach( $elemetns['Enabled'] as $element => $value ){
								echo $this->cea_portfolio_shortcode_elements( $element, $portfolio_array, $settings);
							}
						endif;
			...
			if( ( !$slide_opt ) && $portfolio_infinite ) {
				...
				echo '<div class="page-load-status">';
					if( $loading_img ) echo '<img src="'. esc_url( $loading_img ) .'" alt="'. esc_attr( 'Loading...', 'cea' ) .'" />';
				...
				echo '</div>';
			}elseif( ( !$slide_opt ) && $portfolio_pagination ){
				require_once CEA_PT_CORE_DIR . '/inc/cpt.basic-functions.php';
				echo CPT_Other::CeaBootstrapPagination( $args, $query->max_num_pages, false );
			}			
	...
	function cea_portfolio_shortcode_elements( $element, $opts = array(), $settings = null ){
		$output = '';
		switch( $element ){
				...
				$output .= '<div class="post-icons">';
					$output .= '<ul class="nav">';
						if ( has_post_thumbnail() ) {
							...
							$output .= '<li class="post-magnific-wrap"><a href="#" class="post-magnific image-gallery-link" data-mfp-src="'. esc_url( $featured_img_url ) .'"><span class="ti-zoom-in"></span></a></li>';
						}
						$output .= '<li class="post-link-wrap"><a href="'. esc_url( get_the_permalink() ) .'" class="post-link"><span class="ti-link"></span></a></li>';
					$output .= '</ul>';
				$output .= '</div><!-- .post-icons -->';
			break;
						...
						if( $overlay_opt ){
							...
							$output .= '<div class="post-overlay-items">';
								foreach( $post_overlay_items['Enabled'] as $element => $value ){
									$output .= $this->cea_portfolio_shortcode_elements( $element, $opts );
								}
							$output .= '</div>';
					...
					if( isset( $ele_part ) && !empty( $ele_part ) && $ele_key != 'disabled' ) :
						...
						$output .= '<ul class="nav top-meta-list'. esc_attr( $part_class ) .'">';
							foreach($ele_part as $element => $value ){
								...
								$output .= '<li>'. $this->cea_portfolio_shortcode_elements( $element, $portfolio_array ) .'</li>';
							}
						$output .= '</ul>';
					endif;
				}
