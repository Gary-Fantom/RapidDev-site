...
final class ZOZO_Header_Footer_Extension {
	...
	public function init_widgets() {
		...
		foreach( $hf_widgets as $key ){
			...
			switch( $key ){
				case "logo": Plugin::instance()->widgets_manager->register_widget_type( new ZOZO_HF_Logo_Widget() );  break;
				case "search": Plugin::instance()->widgets_manager->register_widget_type( new ZOZO_HF_Search_Widget() );  break;
				case "secondary-bar": Plugin::instance()->widgets_manager->register_widget_type( new ZOZO_HF_Secondary_Bar() ); break;
				case "menu": Plugin::instance()->widgets_manager->register_widget_type( new ZOZO_HF_Menu_Widget() ); break;
				case "copyright": 
					require_once( ZOZO_HF_CORE_DIR . 'widgets/class-copyright-shortcode.php' );
					Plugin::instance()->widgets_manager->register_widget_type( new ZOZO_HF_Copyright_Widget() );
				break;
				case "page-title": Plugin::instance()->widgets_manager->register_widget_type( new ZOZO_HF_PageTitle_Widget() ); break;
				case "registration": Plugin::instance()->widgets_manager->register_widget_type( new ZOZO_HF_Registration_Widget() ); break;
				case "mini-cart": 
					Plugin::instance()->widgets_manager->register_widget_type( new ZOZO_HF_Minicart_Widget() ); 
				break;
				case "mini-wishlist": 
					Plugin::instance()->widgets_manager->register_widget_type( new ZOZO_HF_Mini_Wishlist_Widget() ); 
				break;
			}
