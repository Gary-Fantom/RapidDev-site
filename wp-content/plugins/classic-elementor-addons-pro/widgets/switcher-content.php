...
class CEA_Elementor_Switcher_Content_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( "Switcher Content", "cea" );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				"label"			=> esc_html__( "Switcher Content Type", "cea" ),
				"description"	=> esc_html__( "This is option for switcher content type either text content or html element. If choose HTML element, then have to put element ID into the each switcher content element box", "cea" ),
				"default"		=> "content",
				"options"		=> [
		...
		$this->start_controls_section(
			...
			[
				"label"	=> esc_html__( "Switcher Content", "cea" ),
				"accordion"	=> Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Switcher content options.", "cea" ),
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Primary Element ID", "cea" ),
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Secondary Element ID", "cea" ),
				"description"	=> esc_html__( "Enter element id", "cea" ),
				"condition" 	=> [
					"switcher_content_type"	=> "element"
				]
		...
		$this->add_group_control(
			...
			[
				'label' 		=> esc_html__( 'Switcher Title Typo', 'cea' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Switch Title Padding', 'cea' ),
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
		...
		$this->start_controls_tabs( 'content_styles' );
			...
			$this->start_controls_tab(
				'secondary_content',
				[
					'label' => esc_html__( 'Secondary', 'cea' ),
				]
			);
			$this->add_control(
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'label' 		=> esc_html__( 'Switcher Content Typo', 'cea' ),
