...
class CEA_Elementor_AnimateText_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'pre_title',
			[
				'label' => __( 'Prefix Text', 'cea' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Prefix Text', 'cea' ),
				"default" 		=> __( 'Prefix Text', 'cea' )
			]
		);
		$this->add_control(
			'post_title',
			[
				'label' => __( 'Suffix Text', 'cea' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Suffix Text', 'cea' ),
				"default" 		=> ''
			]
		);
		...
		$repeater->add_control(
			'ani_text',
			[
				'label'			=> esc_html__( 'Animated Text', 'cea' ),
				'type'			=> Controls_Manager::TEXT,
				'label_block'	=> true,
				'dynamic'		=> [
					'active'	=> true,
		...
		$this->add_control(
			...
			[
				...
				"default" 		=> [
					[
						'ani_text'	=> esc_html__( 'Web', 'cea' ),
					],
					[
						'ani_text'	=> esc_html__( 'App', 'cea' ),
					],
					[
						'ani_text'	=> esc_html__( 'Design', 'cea' ),
					]
				],
		...
		$this->add_control(
			'heading_tag',
			[
				'label' => __( 'Choose heading tag', 'cea' ),
		...
		$this->add_control(
			'startdelay',
			[
				'label' => __( 'Enter start delay', 'cea' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => '1000',
				"default" 		=> '1000'
			]
		...
		$this->add_control(
			'cursor_char',
			[
				'label' => __( 'Enter cursor character', 'cea' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => '|',
				"default" 		=> '|'
			]
		...
		$this->add_control(
			'ani_loop',
			[
				'label' => __( 'Enter animate loop', 'cea' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'true',
				'options' => [
					'true' => __( 'True', 'cea' ),
		...
		$this->start_controls_section(
			"style_section",
			[
				"label"			=> esc_html__( "Style", "cea" ),
				"tab"			=> Controls_Manager::TAB_STYLE,
				"description"	=> esc_html__( "Normal style options here available.", "cea" ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Here you can put the title color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::COLOR,
				"label"			=> esc_html__( "Title", "cea" ),
				"description"	=> esc_html__( "Here you can put the title hover color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				"label"			=> esc_html__( "Animated Text Style", "cea" ),
				"tab"			=> Controls_Manager::TAB_STYLE,
				"description"	=> esc_html__( "Animated text style options here available.", "cea" ),
			]
		);
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::COLOR,
				"label"			=> esc_html__( "Animated Text", "cea" ),
				"description"	=> esc_html__( "Here you can put animated text color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::COLOR,
				"label"			=> esc_html__( "Animated Background", "cea" ),
				"description"	=> esc_html__( "Here you can put animated background color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::COLOR,
				"label"			=> esc_html__( "Animated Text Hover", "cea" ),
				"description"	=> esc_html__( "Here you can put animated text color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::COLOR,
				"label"			=> esc_html__( "Animated Background Hover", "cea" ),
				"description"	=> esc_html__( "Here you can put animated background hover color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_control(
			'animated_padding',
			[
				'label' => esc_html__( 'Animated Text Padding', 'cea' ),
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
