...
class CEA_Elementor_Popover_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				"label"			=> esc_html__( "Select Event", "cea" ),
				"description"	=> esc_html__( "This is option for popover shown by click or hover.", "cea" ),
				"default"		=> "hover",
				"options"		=> [
					"hover"		=> esc_html__( "Hover", "cea" ),
					"click"		=> esc_html__( "Click", "cea" )
				]
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Choose popover trigger image.", "cea" ),
				"dynamic" => [
					"active" => true,
				],
				'default' => [
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Choose popover custom text here.", "cea" ),
		...
		$this->start_controls_section(
			"content_section",
			[
				"label"			=> esc_html__( "Popover Content", "cea" ),
				"tab"			=> Controls_Manager::TAB_CONTENT
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'popover_width',
			[
				'label' => esc_html__( 'Popover Width', 'cea' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function render() {
		...
		switch( $popover_type ){
			...
			case "txt":
				$popover_text = isset( $popover_text ) && $popover_text != '' ? $popover_text : esc_html__( 'Popover', 'cea' );
