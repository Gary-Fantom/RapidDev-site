...
class CEA_Elementor_Icon_List_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			"icon_list_section",
			[
				"label"			=> esc_html__( "Icon List", "cea" ),
				"tab"			=> Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Icon list options available here.", "cea" ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' 		=> [
					'list' 	=> [
						'title' 	=> esc_html__( 'Default', 'cea' ),
						'icon' 		=> 'eicon-editor-list-ul',
					],
					'inline' 	=> [
						'title' => esc_html__( 'Inline', 'cea' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label_block'	=> true,
				'default'		=> esc_html__( 'List Item', 'cea' ),
				'dynamic'		=> [
					'active'	=> true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				"default" 		=> [
					[
						'list_text'	=> esc_html__( 'List Item 1', 'cea' ),
						'list_icon' => [
							'value' => 'ti-heart',
							'library' => 'themify',
						],
					...
					[
						'list_text'	=> esc_html__( 'List Item 2', 'cea' ),
						'list_icon' => [
							'value' => 'ti-target',
							'library' => 'themify',
						],
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label' 		=> esc_html__( 'Space Between', 'cea' ),
		...
		$this->add_control(
			'icon_color',
			[
				'label' 		=> esc_html__( 'Icon Color', 'cea' ),
				'type' 			=> Controls_Manager::COLOR,
				'default' 		=> '',
				'selectors' 	=> [
		...
		$this->add_control(
			'text_indent',
			[
				'label' 		=> esc_html__( 'Text Indent', 'cea' ),
				'type' 			=> Controls_Manager::SLIDER,
				'range' 		=> [
					'px' 		=> [
						'min' 	=> 0,
