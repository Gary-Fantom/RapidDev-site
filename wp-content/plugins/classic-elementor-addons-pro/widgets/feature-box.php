...
class CEA_Elementor_Feature_Box_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			"redirect",
			[
				"label" 		=> esc_html__( "Feature Box Redirect", "cea" ),
				"description"	=> esc_html__( "This is option for when click the feature box redirect to some link.", "cea" ),
		...
		$this->add_control(
			"feature_layout",
			[
				"label"			=> esc_html__( "Feature Box Layout", "cea" ),
		...
		$this->add_control(
			"content_full",
			[
				"label" 		=> esc_html__( "Full Width Content", "cea" ),
				"description"	=> esc_html__( "This is option for enable or disable feature content full width for list style.", "cea" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no",
				"condition" 	=> [
					"layout" 		=> "list"
		...
		$this->add_control(
			"content_self_center",
			[
				"label" 		=> esc_html__( "Content Self Center", "cea" ),
				"description"	=> esc_html__( "This is option for feature box list style right side content set vertically middle.", "cea" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no",
				"condition" 	=> [
					"layout" 		=> "list"
		...
		$this->add_control(
			"icon_self_center",
			[
				"label" 		=> esc_html__( "Icon Self Center", "cea" ),
				"description"	=> esc_html__( "This is option for feature box list style icon/image set vertically middle.", "cea" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no",
				"condition" 	=> [
					"layout" 		=> "list"
		...
		$this->add_control(
			...
			[
				...
				"description"		=> esc_html__( "This is settings for feature box custom layout. here you can set your own layout. Drag and drop needed feature items to Enabled part.", "cea" ),
				"type"				=> "dragdrop",
				"ddvalues" 			=> [ 
					'Enabled' => array( 
					...
					'disabled' => array(
						...
						'number'=> esc_html__( 'Text or Number', 'cea' )
					)
				],
				"condition" 	=> [
					"layout!" 		=> "list"
		...
		$this->add_control(
			...
			[
				...
				"description"		=> esc_html__( "This is settings for feature box custom list layout. here you can set your own layout. Drag and drop needed feature items to Left and Right part.", "cea" ),
				"type"				=> "dragdrop",
				"ddvalues" 			=> [ 
					esc_html__( "Left", "cea" ) => array( 
						"icon"	=> esc_html__( "Icon", "cea" )				
					),
					esc_html__( "Right", "cea" ) => array( 
						"title"	=> esc_html__( "Title", "cea" ),
						"content"	=> esc_html__( "Content", "cea" )					
					),
		...
		$this->add_control(
			...
			[
				...
				"label" 		=> esc_html__( "Ribbon Values", "cea" ),
				"description"	=> esc_html__( "This is option for corner rounded number like ribbon. This option working only when active feature box layout 'Classic Pro'.", "cea" ),
				"default"		=> "",
				"condition" 	=> [
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Feature Box Title", "cea" ),
				"description"	=> esc_html__( "Input feature box title here.", "cea" ),
				"default" 		=>  esc_html__( "Feature Title", "cea" )
			]
		);		
		$this->add_control(
			"title_head",
		...
		$this->add_control(
			...
			[
				...
				"label" => esc_html__( "Feature Box Image", "cea" ),
				"description"	=> esc_html__( "Choose feature box image.", "cea" ),
				"dynamic" => [
					"active" => true,
				],
				'default' => [
		...
		$this->start_controls_section(
			"number_section",
			[
				"label"			=> esc_html__( "Number", "cea" ),
				"tab"			=> Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Number options available here.", "cea" ),
			]
		);	
		$this->add_control(
			"fbox_number",
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Feature Box Number", "cea" ),
				"description"	=> esc_html__( "Enter feature box number. Example 01", "cea" ),
				"default"		=> "01"
			]
		);				
		$this->end_controls_section();		
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Video options available here.", "cea" ),
			]
		);	
		$this->add_control(
			"fbox_video",
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Feature Box Video", "cea" ),
				"description"	=> esc_html__( "Choose feature box video. This url maybe youtube or vimeo video. Example https://www.youtube.com/embed/qAHRvrrfGC4", "cea" ),
				"default"		=> ""
			]
		);
		$this->end_controls_section();	
		...
		$this->add_control(
			...
			[
				...
				"default" 		=> esc_html__( "Feature box content.", "cea" ),
			]
		);
		$this->end_controls_section();	
		...
		$this->add_control(
			...
			[
				...
				"default" 		=> "",
				'selectors' => [
					'{{WRAPPER}} .feature-box-wrapper, {{WRAPPER}} .feature-box-wrapper a' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::COLOR,
				"label"			=> esc_html__( "Number Color", "cea" ),
				"description"	=> esc_html__( "Choose feature box number color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::COLOR,
				"label"			=> esc_html__( "Hover Number Color", "cea" ),
				"description"	=> esc_html__( "Choose feature box hover number color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Hover Opacity', 'cea' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default' => [
					'size' => 10,
		...
		$this->add_control(
			"number_position_opt",
			[
				"label" 		=> esc_html__( "Floating Number Enable", "cea" ),
				"description"	=> esc_html__( "This is option for enable number floating.", "cea" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no"
			]
		);
		...
		$this->add_responsive_control(
			'number_spacing',
			[
				'label' => esc_html__( 'Number Spacing', 'cea' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 5,
				],
