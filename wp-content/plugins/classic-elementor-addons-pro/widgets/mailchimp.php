...
class CEA_Elementor_Mailchimp_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$mc_lists = array( '' => esc_html__( "Select List", "cea" ) );
		if( $api_key ){
		...
		$this->start_controls_section(
			"mailchimp_section",
			[
				"label"	=> esc_html__( "Mailchimp", "cea" ),
				"tab"	=> Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Default mailchimp options.", "cea" ),
			]
		);
		$this->add_control(
			'layout',
		...
		$this->add_control(
			"first_name_opt",
			[
				"label" 		=> esc_html__( "Enable First Name", "cea" ),
		...
		$this->add_control(
			...
			[
				...
				"label" 		=> esc_html__( "First Name Label/Placeholder", "cea" ),
				"default" 		=> esc_html__( "First Name", "cea" ),
				'condition' => [
					'first_name_opt' => 'yes'
				],
			]
		...
		$this->add_control(
			"last_name_opt",
			[
				"label" 		=> esc_html__( "Enable Last Name", "cea" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no"
			]
		);
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Last Name Label/Placeholder", "cea" ),
				"default" 		=> esc_html__( "Last Name", "cea" ),
				'condition' => [
					'last_name_opt' => 'yes'
				],
			]
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Email Label/Placeholder", "cea" ),
				'default' 		=> esc_html__( "Subscribe", "cea" ),
			]
		);
		if( !empty( $result ) ){
			$this->add_control(
				'list_id',
				[
					'label' => esc_html__( 'Select List ID', 'cea' ),
					'type' => Controls_Manager::SELECT,
					'options' => $mc_lists,
					'default' => 'default',
				]
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf( __( '<b>Note:</b> You may forget to put mailchimp API on Classic Elementor Addon -> Plugin Options -> General -> Mailchimp API', 'cea' ) ),
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Button Label", "cea" ),
				'default' 		=> esc_html__( "Subscribe", "cea" ),
				'condition' => [
					'btn_type' => 'text'
				],
		...
		$this->add_control(
			...
			[
				...
				"label" 		=> esc_html__( "Success Message", "cea" ),
				'default' 		=> esc_html__( "Email added successfully.", "cea" ),
			]
		);
		$this->add_control(
			"failure_label",
			[
				"type"			=> Controls_Manager::TEXTAREA,
				"label" 		=> esc_html__( "Failure Message", "cea" ),
				'default' 		=> esc_html__( "Subscribe", "cea" ),
				'default' 		=> esc_html__( "Email added process failed.", "cea" ),
			]
		);		
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Placeholder Color', 'cea' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
