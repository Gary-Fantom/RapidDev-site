	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				"label" 		=> esc_html__( "Event Line Distance", "cea" ),
				"description"	=> esc_html__( "This is option for timeline event line distance. If you use timeline for years make distance volume low.", "cea" ),
				"default" 		=> "60",
			]
		);	
		...
		$repeater->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Timeline Date", "cea" ),
				"description"	=> esc_html__( "Here you can put the timeline date. Must follow the date format dd/mm/yyyy. Example 16/01/2014", "cea" ),
				"default"		=> ""
			]
		);
		$repeater->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Timeline Separator Title", "cea" ),
		...
		$this->add_control(
			"timeline_settings",
			[
				"label"			=> esc_html__( "Timeline Setting", "cea" ),
				"description"	=> esc_html__( "This is options for timeline.", "cea" ),
				"type"			=> Controls_Manager::REPEATER,
				"fields"		=> $repeater->get_controls(),
				"default"		=> [
					[
						"timeline_title" 	=> esc_html__( "History", "cea" ),
						"timeline_date"		=> "01/01/2012",
						"timeline_separator"=> esc_html__( "01 Jan", "cea" ),
						"timeline_subtitle"	=> esc_html__( "1st January, 2012", "cea" ),
		...
		$this->add_control(
			'timeline_color',
			[
				'label' => esc_html__( 'Timeline Color', 'cea' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Line Dot Color', 'cea' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Timeline Title Color', 'cea' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'timeline_subtitle',
			[
				'label' => __( 'Timeline Sub Title', 'cea' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Timeline Sub Title Color', 'cea' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'timeline_separator',
			[
				'label' => __( 'Timeline Separator', 'cea' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Timeline Separator Color', 'cea' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
